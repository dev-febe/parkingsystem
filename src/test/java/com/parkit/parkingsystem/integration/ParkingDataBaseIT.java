...
public class ParkingDataBaseIT {
    ...
    @DisplayName("Should check that the fare generated and out time are populated correctly in the database")
    @Test
    public void testParkingLotExit() throws Exception {
        ...
        //set 24 hours parking time should give 24 * parking fare per hour
